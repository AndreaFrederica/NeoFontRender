...
/**
 * Converts the information available to a 1.7.10 client into monotonic local chunk readiness.
 *
 * <p>The 1.7.10 protocol does not transmit the server's total chunk target. The displayed value is
