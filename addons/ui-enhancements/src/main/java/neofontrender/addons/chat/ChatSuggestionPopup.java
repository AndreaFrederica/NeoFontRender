...
public final class ChatSuggestionPopup {
    ...
    public static Layout draw(GuiTextField input, List<String> candidates, int first, int selected,
        ...
        int inputX = tabbyGeometry == null ? input.xPosition : tabbyGeometry.x;
        int inputY = tabbyGeometry == null ? input.yPosition : tabbyGeometry.y;
        ...
        GL11.glPushMatrix();
        GL11.glTranslatef(panelX, panelY, 600.0F);
