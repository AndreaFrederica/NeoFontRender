...
public final class ObscureTooltipCompat {
    private static final ThreadLocal<ItemStack> ACTIVE_STACK = new ThreadLocal<ItemStack>();
    ...
    /** Replaces Obscure's fading header line with the configured NFR divider. */
