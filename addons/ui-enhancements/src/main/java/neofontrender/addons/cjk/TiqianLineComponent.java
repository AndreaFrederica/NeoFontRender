...
public final class TiqianLineComponent extends ChatComponentText implements PositionedTextLine {
    ...
    public void nfrUi$addComponentSpan(int start, int end, IChatComponent component) {
    ...
    @Override
    public IChatComponent nfrUi$componentAt(float x) {
    ...
    @Override
    public float nfrUi$componentLeft(IChatComponent component) {
        for (ComponentSpan span : components) {
    ...
    @Override
    public float nfrUi$componentRight(IChatComponent component) {
        for (ComponentSpan span : components) {
    ...
    private static final class ComponentSpan {
        ...
        private ComponentSpan(int start, int end, IChatComponent component) {
            this.start = start;
            this.end = end;
