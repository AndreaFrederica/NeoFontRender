...
import neofontrender.addons.vendor.tabbychat.foundation.gui.events.GuiKeyboardEvent;
import neofontrender.addons.vendor.tabbychat.foundation.sound.SoundCatalog;
...
public class GuiFilterEditor extends GuiPanel {
    ...
    private class ToggleButton extends GuiButton {
        ...
        public String getText() {
            ...
            EnumChatFormatting color = active ? EnumChatFormatting.GREEN : EnumChatFormatting.RED;
            return color + text;
        }
    ...
    public GuiFilterEditor(UserFilter filter, Consumer<UserFilter> consumer) {
        ...
        txtSound.getBus().register(new Object() {
            ...
            public void suggestSounds(GuiKeyboardEvent event) {
                ...
                List<String> list = SoundCatalog.listSounds().stream()
