...
public abstract class GuiComponent extends Gui {
    ...
    private IChatComponent caption;
    ...
    public void setCaption(@Nullable IChatComponent text) {
        this.caption = text;
    }
    ...
    public String getCaption() {
        return getCaptionText().map(IChatComponent::getFormattedText).orElse(null);
    }

    public Optional<IChatComponent> getCaptionText() {
