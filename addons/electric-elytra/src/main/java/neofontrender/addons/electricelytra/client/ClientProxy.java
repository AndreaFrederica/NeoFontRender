...
public final class ClientProxy extends CommonProxy {
    ...
    @Override public void preInit() {
        ...
        registerVanillaElytraModel(ElectricElytraItems.CREATIVE_VANILLA_ELECTRIC_ELYTRA,
                "creative_vanilla_electric_elytra");
        registerVanillaElytraModel(ElectricElytraItems.ELECTRIC_ELYTRA, "electric_elytra");
        registerVanillaElytraModel(ElectricElytraItems.ADVANCED_ELECTRIC_ELYTRA,
                "advanced_electric_elytra");
        registerVanillaElytraModel(ElectricElytraItems.ADVANCED_FLAP_ELECTRIC_ELYTRA,
                "advanced_flap_electric_elytra");
        registerVanillaElytraModel(ElectricElytraItems.CREATIVE_ELECTRIC_ELYTRA,
    ...
    @Override public void init() {
        ...
        MinecraftForge.EVENT_BUS.register(ElectricFlightDebugRenderer.INSTANCE);
        FlightApi.registerCapabilityProvider(new ResourceLocation(ElectricElytraMod.MOD_ID,
            ...
            boolean editingHud = player == Minecraft.getMinecraft().player
            ...
            if (ItemElectricElytra.usesVanillaFlightModel(stack)) {
                if (capability == FlightCapability.HUD) {
                    return player.isElytraFlying() || ItemElectricElytra.isEngineEnabled(stack)
        ...
        for (RenderPlayer renderer : Minecraft.getMinecraft().getRenderManager().getSkinMap().values()) {
            renderer.addLayer(new ElectricElytraLayer(renderer));
        }
    }
    ...
    public void onClientTick(TickEvent.ClientTickEvent event) {
        ...
        if (equipped && minecraft.currentScreen == null) {
            ...
            while (TOGGLE_SAS.isPressed() && ItemElectricElytra.isSasCapable(chest)) {
                FlightAttitude attitude = minecraft.player.isElytraFlying()
