...
An optional Minecraft 1.12.2 submod built on Revo UI's Flight API v4.
...
The item exposes Forge Energy capability and can be charged by compatible FE/RF equipment. A new
or newly crafted Electric Elytra starts with 240,000 FE.
